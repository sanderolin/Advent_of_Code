...
public class SomeAssemblyRequired02 {
    ...
    public static void solve() {
        wires = new HashMap<>();
        readFromFile();
        overrideWire("b", findWireValue("a"));
        resetAllWireValues();
    ...
    private static void overrideWire(String wire, int value) {
        wires.put(wire, new Instruction(String.valueOf(value), Operation.ASSIGN, null, value));
    }

    private static void resetAllWireValues() {
        for (Instruction instruction : wires.values()) {
