...
public class KnightsOfTheDinnerTable02 {
    ...
    public static void solve() {
        readFromFile();
        insertMyself();
        List<List<String>> everyPermutations = new ArrayList<>();
        getPermutations(0, everyPermutations);
        System.out.println(findBestHappinessScore(everyPermutations));
    }
    ...
    private static void insertMyself() {
        String me = "Sander";
        for (String person : people) {
            relations.put(new Pair(me, person), 0);
            relations.put(new Pair(person, me), 0);
        }
        people.add(me);
    }
